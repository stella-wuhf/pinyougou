//服务层
app.service('typeTemplateService2',function($http){
	...
	this.search=function(page,rows,searchEntity){
		return $http.post('../typeTemplate/searchst.do?page='+page+"&rows="+rows, searchEntity);
	}
    //更改状态
    this.updateStatus = function(ids,status){
        return $http.get('../typeTemplate/updateStatusst.do?ids='+ids+"&status="+status);
    }
});
